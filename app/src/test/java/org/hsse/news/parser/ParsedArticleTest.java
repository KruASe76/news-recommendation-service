...
class ParsedArticleTest {
    ...
    ParsedArticle testArticle = new ParsedArticle("Meet the guy", "Chris Fowler, Director of Engine for Call of Duty.", "15 ноября 2024", "https://stackoverflow.blog/2024/11/15/meet-the-guy-responsible-for-building-the-call-of-duty-game-engine/", Set.of("gaming"),"Eira May", "StackOverflow");
    @Test
    void testRecord(){
        ...
        assertEquals(testArticle.link(), "https://stackoverflow.blog/2024/11/15/meet-the-guy-responsible-for-building-the-call-of-duty-game-engine/");
